!(function () {
    const e = "difyChatbotConfig",
        t = "dify-chatbot-bubble-button",
        n = "dify-chatbot-bubble-window",
        o = window[e],
        i = {
    ...
    async function d() {
        const d = new URLSearchParams(
            await (async function () {
                ...
                return (
                    await Promise.all(
                        Object.entries(e).map(async ([e, n]) => {
                            t[e] = await (async function (e) {
        ...
        function c() {
            ...
            if (e && o) {
                const t = o.getBoundingClientRect(),
                    ...
                    d = t.left;
                (e.style.bottom = `${n + t.height + 5 + e.clientHeight > window.innerHeight
                    ? n - e.clientHeight - 5
                    : n + t.height + 5
                    }px`),
                    (e.style.right = `${i + e.clientWidth > window.innerWidth
                        ? window.innerWidth - d - e.clientWidth
                        : i
                        }px`);
            }
        }
        s.length > 2048 &&
            ...
            (function () {
                ...
                Object.entries(o.containerProps || {}).forEach(([t, n]) => {
                    "className" === t
                        ...
                        : "style" === t
                            ? "object" == typeof n
                                ...
                                : (e.style.cssText = n)
                            : "function" == typeof n
                                ? e.addEventListener(t.replace(/^on/, "").toLowerCase(), n)
                                : (e[t] = n);
                }),
                    (e.id = t);
                    ...
                    e.addEventListener("click", function () {
                        ...
                        if (!e)
                            return (
                                ...
                                (this.title = "Exit (ESC)"),
                                (l.innerHTML = i.close),
                                void document.addEventListener("keydown", r)
                            );
                        (e.style.display = "none" === e.style.display ? "block" : "none"),
                            (l.innerHTML = "none" === e.style.display ? i.open : i.close),
                        ...
                        function l(c) {
                            ...
                            l &&
                                ((l.style.display = "none"),
                                    (e.querySelector("div").innerHTML = i.open));
                            const a = c.clientX - d,
                                h = window.innerHeight - c.clientY - r,
                                p = e.getBoundingClientRect(),
                                u = window.innerWidth - p.width,
                                m = window.innerHeight - p.height;
                            ("x" !== o && "both" !== o) ||
                                e.style.setProperty(
                                    `--${t}-left`,
                                    `${Math.max(0, Math.min(a, u))}px`
                                ),
                                ("y" !== o && "both" !== o) ||
                                e.style.setProperty(
                                    `--${t}-bottom`,
                                    `${Math.max(0, Math.min(h, m))}px`
                                );
                        }
                        function a() {
                            (s = !1),
        ...
        if ("Escape" === e.key) {
            ...
            e &&
                ...
                ((e.style.display = "none"),
                    (o.querySelector("div").innerHTML = i.open));
        }
    }
    document.addEventListener("keydown", r),
        o?.dynamicScript ? d() : (document.body.onload = d);
})();
